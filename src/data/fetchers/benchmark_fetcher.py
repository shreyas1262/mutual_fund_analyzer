...
def demo_pyspark_usage():
    ...
    try:
        ...
        all_schemes_df = fetcher.get_all_schemes(save_path="data/raw/schemes/all_schemes.parquet")
        ...
        axis_schemes = fetcher.search_schemes_spark(
            keyword="Axis", 
            scheme_type="Equity",
            save_path="data/raw/schemes/axis_schemes.parquet"
        )
        ...
        pivot_df = fetcher.create_pivot_nav_dataset(
            combined_nav_df,
            save_path="data/processed/pivoted/pivot_nav_data.parquet"
        )
        ...
        performance_df.write.mode("overwrite").parquet("data/analysis/performance/basic_performance_metrics.parquet")
        ...
        # Save monthly data
        monthly_data.write.mode("overwrite").parquet("data/processed/returns/monthly_nav_data.parquet")
        
        print("\nDemo completed successfully!")
        print("Files created:")
        print("- data/raw/schemes/all_schemes.parquet")
        print("- data/raw/nav/mf_historical_data.parquet") 
        print("- data/processed/pivoted/pivot_nav_data.parquet")
        print("- data/analysis/performance/basic_performance_metrics.parquet")
        print("- data/processed/returns/monthly_nav_data.parquet")
